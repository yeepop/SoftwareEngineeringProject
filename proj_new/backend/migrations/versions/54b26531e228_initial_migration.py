...
def upgrade():
    ...
    # 添加循環外鍵約束
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_users_primary_shelter_id', 'shelters', ['primary_shelter_id'], ['shelter_id'])
    
    with op.batch_alter_table('shelters', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_shelters_primary_account_user_id', 'users', ['primary_account_user_id'], ['user_id'])
